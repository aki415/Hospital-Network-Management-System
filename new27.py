...
class Hospital:
    ...
    def network_connect(self):
        self.ip = str(raw_input("Please enter the ip address:"))
        self.port = int(raw_input("Please enter the port:"))
...
def getpassword():
    abc = raw_input("Please enter password: ")
...
if __name__ == '__main__':
    ...
    if password != "89e01536ac207279409d4de1e5253e01f4a1769e696db0d6062ca9b8f56767c8":
        ...
        while True:
            bool = raw_input("Do you wish to continue ? (reply with Y/N)")
            if bool == "Y":
                if temp == 0 :
